...
#define DUMP i=nynz*ix+nz*iy+iz; fscanf(streamw,"%lf", &dummy1);Bx[i]=dummy1;fscanf(streamw,"%lf", &dummy1);By[i]=dummy1;fscanf(streamw,"%lf", &dummy1);Bz[i]=dummy1;
/*
...
if((streamw = fopen("B1.bin","rb")) == NULL) { printf("\n Error B.bin"); exit(1);}
